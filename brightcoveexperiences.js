...
if (brightcove.experiences == undefined) {
    ...
    brightcove.defaultFlashParam.secureConnections = true;
    brightcove.defaultFlashParam.secureHTMLConnections = true;
        ...
        if (playerType === brightcove.playerType.HTML) {
            ...
            window.addEventListener('message', function (event) {
                ...
                if (brightcove.hasActiveX) {
                    ...
                    playerConfig = {activeX: flashEmbedStr, height: experience.params.height, id: '_container' + experience.id, file: file};
                } else {
    ...
    brightcove.handleExperienceTimeout = function (pID) {
        brightcove.executeErrorHandlerForExperience(brightcove.experienceObjects[pID], {type: "templateError", errorType: "serviceUnavailable", code: brightcove.errorCodes.SERVICE_UNAVAILABLE, info: pID});
    };
    ...
    brightcove.reportUpgradeRequired = function (pExperience) {
        brightcove.executeErrorHandlerForExperience(pExperience, {type: "templateError", errorType: "upgradeRequiredForPlayer", code: brightcove.errorCodes.UPGRADE_REQUIRED_FOR_PLAYER, info: pExperience.id});
    };
